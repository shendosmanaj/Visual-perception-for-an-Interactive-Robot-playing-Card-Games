"""
Program for running the  the Card detection through webcam or recorded video.
...
def YOLO():
    ...
    #cap = cv2.VideoCapture(0)   # Uncomment this line if you want to run the program recording from your webcam
    #cap = cv2.VideoCapture(0, cv2.CAP_DSHOW)
    cap = cv2.VideoCapture("MOV_2400.mp4") # Uncomment this if you want to rune the program on a video.
    # cap.set(3, 1280)
    # cap.set(4, 720)
